...
#define SBK_QTGUI_QVECTOR_QTEXTLENGTH_IDX                            1 // QVector<QTextLength >
#define SBK_QTGUI_QMAP_INT_QVARIANT_IDX                              2 // QMap<int, QVariant >
#define SBK_QTGUI_QLIST_QTEXTOPTION_TAB_IDX                          3 // const QList<QTextOption::Tab > &
...
#define SBK_QTGUI_QLIST_QABSTRACTBUTTONPTR_IDX                       41 // QList<QAbstractButton * >
